...
export function ScheduleHomeInClassBanner({
  ...
  const cardShellClass = cn(
    'home-glass-chip rounded-lg border border-t-0 border-r-0 border-primary/25 bg-primary/10 px-2 py-2 sm:px-2.5 sm:py-2 text-left shadow-sm box-border min-w-0',
